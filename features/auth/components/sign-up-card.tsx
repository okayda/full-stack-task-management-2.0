...
export default function SignUpCard() {
  ...
  const onSubmit = async function (data: z.infer<typeof createUserSchema>) {
  ...
  return (
    <Card className="mx-auto max-w-[400px] rounded-none border-none shadow-none sm:max-w-[410px] lg-l:mx-0 lg-l:flex lg-l:w-full lg-l:max-w-none lg-l:gap-x-6 lg-l:bg-transparent">
