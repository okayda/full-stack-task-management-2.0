...
export default function SignUpCard() {
  ...
  return (
    <div>
          ...
          <div className="absolute inset-0 px-10 pt-9">
            <div className="text-left text-white">
              ...
              >
                ...
                created this project solely for my own educational purposes.
                Thank you.
              </p>
      ...
      <div className="mx-auto max-w-[400px] py-6 sm:max-w-[410px] lg-l:hidden">
        ...
        <p className="mb-4">
          ...
          <span className="text-emerald-600">purely coincidental</span>. I
        ...
        <p>
          Sincerely,{" "}
          <span className="text-emerald-600"> Jhon Que&ntilde;ano</span>
        </p>
      </div>
    </div>
  );
