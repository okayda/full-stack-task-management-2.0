...
export default function SignInCard() {
  ...
  return (
    <div className="mx-auto max-w-[1200px]">
      <Card className="mx-auto max-w-[400px] rounded-none border-none shadow-none lg-l:mx-0 lg-l:flex lg-l:w-full lg-l:max-w-none lg-l:gap-x-4">
        <div className="lg-l:w-full lg-l:max-w-[410px]">
